...
- GitHub → the [wickra-screener repository](https://github.com/wickra-lib/wickra-screener)
...
Wickra Screener parses untrusted `ScanSpec` JSON and candle data, so its parser and
...
[SECURITY.md](https://github.com/wickra-lib/wickra-screener/blob/main/SECURITY.md)
